  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-surface-200 border border-border-subtle rounded-3xl p-5 lg:p-8">
        ...
        <div className="space-y-6">
          <div className="bg-[#111] border border-white/5 rounded-3xl p-5 lg:p-6">
            <h3 className="text-xs font-bold uppercase tracking-widest text-text-200 mb-4">Top Performer</h3>
            {bestStrategy ? (
              <div className="space-y-4">
                <div className="p-4 bg-emerald-500/10 rounded-2xl border border-emerald-500/20">
                  ...
                  <div className="grid grid-cols-2 gap-3 lg:gap-4">
                    <div className="p-4 bg-surface-300 rounded-2xl">
                      <p className="text-[10px] text-text-200 font-medium">Win Rate</p>
                      <p className="text-base lg:text-lg font-bold">{bestStrategy.winRate.toFixed(1)}%</p>
                    </div>
                    <div className="p-4 bg-surface-300 rounded-2xl">
                      <p className="text-[10px] text-text-200 font-medium">Total Profit</p>
          ...
          <div className="bg-surface-200 border border-border-subtle rounded-3xl p-5 lg:p-6">
            <h3 className="text-xs font-bold uppercase tracking-widest text-text-200 mb-4">Win Rate Comparison</h3>
            <div className="space-y-4">
              {strategyData.sort((a, b) => b.winRate - a.winRate).map(s => (
                <div key={s.name} className="space-y-2">
                  <div className="flex justify-between text-xs lg:text-sm">
                    <span className="text-text-200">{s.name}</span>
