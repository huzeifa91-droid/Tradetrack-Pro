  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        <div className="lg:col-span-2 bg-[#111] border border-white/5 rounded-3xl p-4 lg:p-8 overflow-x-auto">
          <Calendar 
            onChange={onChange} 
            value={value} 
            tileContent={tileContent}
            className="w-full bg-transparent border-none text-white min-w-[300px]"
          />
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-[#111] border border-white/5 rounded-3xl p-5 lg:p-6">
            ...
            <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5">
              <span className="text-gray-400 text-xs lg:text-sm">Daily P/L</span>
          ...
          <div className="bg-[#111] border border-white/5 rounded-3xl p-5 lg:p-6">
            <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-4">Trades on this day</h3>
            <div className="space-y-3">
              {selectedDayTrades.map(trade => (
                <div key={trade.id} className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5">
                  <div>
                    <div className="font-bold text-sm lg:text-base">{trade.pair}</div>
                    <div className="text-[10px] lg:text-xs text-gray-500 uppercase">{trade.type} • {trade.strategy}</div>
                  </div>
