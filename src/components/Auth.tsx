    ...
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden min-h-[40vh] lg:min-h-screen">
        ...
        <div className="relative z-10 flex items-center gap-2 lg:gap-3">
          <div className="w-8 h-8 lg:w-10 lg:h-10 bg-white/5 rounded-lg lg:rounded-xl flex items-center justify-center shadow-2xl overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mt-8 lg:mt-0">
          ...
          <p className="text-gray-400 mt-4 lg:mt-6 text-sm lg:text-lg leading-relaxed">
        ...
        <div className="relative z-10 text-gray-500 text-[10px] lg:text-sm mt-8 lg:mt-0">
          © 2026 TradeTrack Pro. All rights reserved.
        </div>
      </div>

      {/* Right Side - Login */}
      <div className="lg:w-1/2 flex items-center justify-center p-8 lg:p-12 bg-[#0F0F0F] flex-1">
        <motion.div 
        ...
        >
          <div className="text-center">
            ...
            <p className="text-gray-500 mt-2 text-sm lg:text-base">Join thousands of traders improving their edge.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <button 
              ...
              disabled={isLoading}
              className="w-full bg-white text-black py-3.5 lg:py-4 rounded-xl lg:rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-gray-100 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
            ...
            <div className="relative py-2 lg:py-4">
              ...
              <div className="relative flex justify-center text-[10px] uppercase">
                <span className="bg-[#0F0F0F] px-4 text-gray-500 font-bold tracking-widest">Secure Access</span>
              </div>
            </div>

            <p className="text-center text-[10px] lg:text-xs text-gray-500 leading-relaxed">
